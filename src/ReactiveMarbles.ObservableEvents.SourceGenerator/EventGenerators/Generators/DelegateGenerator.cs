...
namespace ReactiveMarbles.ObservableEvents.SourceGenerator.EventGenerators.Generators
{
    ...
    internal static class DelegateGenerator
    {
        ...
        internal static IEnumerable<NamespaceDeclarationSyntax> Generate(IEnumerable<(INamedTypeSymbol TypeDefinition, bool IsAbstract, IEnumerable<IMethodSymbol> Methods)> declarations)
        {
        ...
        private static ClassDeclarationSyntax GenerateClass(INamedTypeSymbol typeDefinition, bool isAbstract, IEnumerable<IMethodSymbol> methods)
        {
        ...
        private static IEnumerable<MemberDeclarationSyntax> GenerateObservableMembers(IEnumerable<IMethodSymbol> methods)
        {
